...
public class EmbedUtil {
    ...
    public static EmbedBuilder success(String title, String description) {
        return embed(":white_check_mark: " + title, description).setColor(Color.MAGENTA);
    }

    public static EmbedBuilder premium(String title, String description) {
        return embed(":star: " + title, description).setColor(Color.yellow);
    }
    ...
    public static EmbedBuilder info(String title, String description) {
        return embed(":information_source: " + title, description).setColor(Color.BLACK);
    }
    ...
    public static EmbedBuilder no_permissions() {
        return embed(":warning: " + "No permissions", "You don't have the permission to execute this command!").setColor(Color.MAGENTA);
    }
    ...
    public static EmbedBuilder withTimestamp(EmbedBuilder embedBuilder) {
        return embedBuilder.setFooter("FOOTER LOL", null);
    }
